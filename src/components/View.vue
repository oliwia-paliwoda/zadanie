...
const nextSlide = () => {
  currentImage.value = (currentImage.value + 1) % imagesSlider.length
  console.error("next");
}
...
const prevSlide = () => {
  currentImage.value =
      (currentImage.value - 1 + imagesSlider.length) % imagesSlider.length
  console.error("prev");
}
...
const handleImageClick = (e) => {
  ...
  const scaleX = 688 / rect.width
  const scaleY = 737 / rect.height
...
<template>
  ...
  <div class="w-[full] min-h-screen overflow-y-auto flex flex-col">
      ...
      <Transition name="dropdown">
        ...
        >
          <ul class="flex flex-col p-6 gap-6">
            <li>
              <div class="flex flex-row items-center gap-2" @click="ofertaOpen =! ofertaOpen">
                <p>Oferta</p>
                <svg :class="{ 'rotate-180': ofertaOpen }"
                     class="transition-transform duration-200" fill="none" height="12" viewBox="0 0 12 12" width="12"
                     xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col md:flex-row bg-[#DCC1AB]">
      ...
      <div class="w-full md:w-1/2 aspect-[688/737]  relative">
        <img
            :src="imagesSlider[currentImage].url"
      ...
      <div id="oferta-text" class="h-[60%] w-[80%] flex flex-col">
        ...
        <div class="text-[#111111]">
          <h3>Oferujemy kompletną obsługę inwestycji terenów zielonych. Projektujemy nowoczesne ogrody przydomowe oraz
            ...
            posłużymy radą i wieloletnim doświadczeniem. </h3>
        </div>
    ...
    <div id="firma" class="flex flex-col md:flex-row bg-[#1B5B31]">
    ...
    height: expanded ? gridHeight + 'px' : '120vh'
      ...
      >
        ...
        >
          ...
          <svg :class="expanded ? 'rotate-180' : 'rotate-0'" fill="none" height="16" viewBox="0 0 16 16" width="16"
               xmlns="http://www.w3.org/2000/svg">
            <path
