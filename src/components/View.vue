...
const expandGrid = () => {
  ...
  <template>
    <div class="w-[100vw] h-[100vh] overflow-y-scroll flex flex-col">


      <!-----------------NAVI-------------------------->
    <div class="flex flex-row justify-between items-center bg-white h-[72px] py-6 px-12 w-[100%]">
      <img src="/giarddesign.png" class="w-[114.37px] h-[19px]">
      <div class="flex flex-row items-center p-0 gap-[48px]">

          <div class="flex items-center justify-center gap-[2px]">
          <p class=" text-[14px] font-normal leading-[-150%] tracking-[-0.01em] text-[#111111]">Oferta</p>
      ...
      <div id="oferta" class="flex flex-col items-center justify-center bg-[#F5F0EC] w-[100%] h-auto px-12 pt-[120px] gap-[96px]">
        ...
        <div id="oferta-elements" class="flex flex-col lg:flex-row items-center justify-center w-[100wv] gap-[64px]">
          <div id="element" class="bg-white rounded-xl aspect-[1/1] w-[25vw] flex flex-col px-6 py-8 gap-10">
            <div id="icon+text" class="flex flex-col gap-10">
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <div id="element-text" class="flex flex-col gap-2">
                <div class="text-xl">
                  <p>Projekty</p>
                </div>
                <div class="text-xs">
            ...
            <div class="text-[#1B5B31] text-sm underline flex flex-row items-center justify-start gap-2 mt-auto">
